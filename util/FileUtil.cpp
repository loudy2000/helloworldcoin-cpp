...
{
	string path = FileUtil::newPath("/home/zcr/helloworldcoin-cpp/trunk/util", "child");
	cout << "path = " << path << endl;

	FileUtil::makeDirectory(path);

	FileUtil::deleteDirectory("/home/zcr/helloworldcoin-cpp/trunk/util/openssl-1.1.1l/test");
	return 0;
}
#endif
